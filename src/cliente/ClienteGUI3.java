...
public class ClienteGUI3 extends javax.swing.JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ClienteGUI3 window = new ClienteGUI3();
	...
	public ClienteGUI3() {
        ...
        try {
            ...
            Logger.getLogger(ClienteGUI3.class.getName()).log(Level.SEVERE, null, ex);
	...
	*/
	...
	private void initialize() {
		...
		JButton btnPoupanca = new JButton("Poupan�a");
		...
		JLabel lblSimulaes = new JLabel("Simula��es");
		...
		JLabel lblContaPoupana = new JLabel("Conta Poupan�a");
		...
		JCheckBox chckbxPoupana = new JCheckBox("Poupan�a");
		...
		JCheckBox checkBox_1 = new JCheckBox("Poupan�a");
		...
		txtNmeroDaConta.setText("N�mero da Conta");
		...
		JLabel lblSimulaoDeInvestimento = new JLabel("Investimento na poupan�a");
		lblSimulaoDeInvestimento.setHorizontalAlignment(SwingConstants.CENTER);
		
		JLabel lblSaldoAtual = new JLabel("Investimento");
		
		JLabel lblApsMeses = new JLabel("Ap�s 3 meses");
		
		JLabel lblMes = new JLabel("Ap�s 6 meses");
		...
		JLabel lblApsMeses_1 = new JLabel("Ap�s 12 meses");
		...
		JLabel label = new JLabel("Ap�s 12 meses");
		...
		JLabel label_6 = new JLabel("Ap�s 6 meses");
	...
	private void btnDepsitoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteGUI3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	/*
                new ClienteGUI3().setVisible(true);
                */
